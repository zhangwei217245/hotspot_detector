...
def main():
    ...
    print("The total number of outliers = ", "{0:1}".format(num_outlier,2), ", the number of all core samples = ", len(db.core_sample_indices_), ", the number of all instances =", len(labels))
